...
// Seed data — pushed to Firestore once via scripts/seed.js so the store
// looks complete on first load. After seeding, all product data lives in
// Firestore and is managed from /admin.
...
export const DEFAULT_HOMEPAGE = {
  ...
  heroImage: "https://images.unsplash.com/photo-1585386959984-a4155224a1ad?w=1400&q=80",
  ...
  promoImage: "https://images.unsplash.com/photo-1526406915894-7bcd65f60845?w=1400&q=80",
};
